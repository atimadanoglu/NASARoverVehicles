...
class SpiritPhotosAdapter(
    private val fragmentManager: FragmentManager,
    private val context: Context
): ListAdapter<Photo, SpiritPhotosAdapter.ViewHolder>(SpiritDiffUtil()) {
    class ViewHolder(private val binding: CuriosityViewHolderBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(photo: Photo, context: Context, fragmentManager: FragmentManager) {
            ...
            binding.root.setOnClickListener {
                ...
                dialog.show(fragmentManager, "spiritDialog")
            }
        }
    }
...
class SpiritDiffUtil: DiffUtil.ItemCallback<Photo>() {
